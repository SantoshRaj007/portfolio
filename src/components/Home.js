            ...
            <div className="row g-5 py-5">
                <div className="col-lg-7 align-self-center text-center text-lg-start mb-lg-5 p-r">
                    <div className="pt-lg-5 pb-lg-5">
                        <Link to="" className="btn btn-sm border rounded-pill text-white px-3 mb-3 animated slideInRight">TechVibe</Link>
                        ...
                        <div className="d-flex banner-btn">
                            <Link to="" className="btn btn-primary py-sm-3 px-sm-5 me-3 rounded-pill" tittle="Read More">Read More</Link>
                            <Link to="" className="btn btn-primary-outline py-sm-3 px-sm-5 rounded-pill" tittle="Contact Us">Contact Us</Link>
                        </div>
                    </div>
                </div>
