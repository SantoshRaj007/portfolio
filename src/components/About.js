                    ...
                    <div className="row g-5 align-items-center py-5">
                        ...
                        <div className="col-lg-6">
                            <div className="about-content">
                                <div>
                                    <Link to="" className="btn btn-sm border rounded-pill link  px-3 mb-4">About Us</Link>
                                ...
                                <div className="d-flex align-items-center mt-4 social-links">
                                    <Link to="" className="btn btn-primary rounded-pill px-4 me-3">Read More</Link>

                                    <Link to="" className="btn btn-outline-primary btn-square me-3">
